  ...
  const fetchProduct = async () => {
    try {
      ...
      setFormData({
        ...
        certification: product.certification || 'Lab Certified',
        images: [],
        ...
        <div className="bg-white rounded-lg shadow p-8">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            {existingImages.length > 0 && (
              <div>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Current Images</h2>
            ...
            {/* New Product Images */}
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-4">Add New Images</h2>
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500 mt-1">
                    Upload new images to add to the product
                  </p>
                </div>

                {formData.images.length > 0 && (
                  <div>
                    <h3 className="font-medium text-gray-900 mb-2">New Images ({formData.images.length}):</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
